package com.pallaw.jetpackcomposebasicscodelab
...
import com.pallaw.jetpackcomposebasicscodelab.ui.theme.JetpackComposeBasicsCodelabTheme
...
fun MyApp(
    ...
    Surface(modifier = modifier) {
        if (shouldShowOnBoardingScreen) {
            OnboardingScreen {
                shouldShowOnBoardingScreen = !shouldShowOnBoardingScreen
            }
        } else {
            Greetings()
        }
